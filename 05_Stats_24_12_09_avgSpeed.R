...
m1 <- glmmTMB(front ~ rank + age2 + sex + rank*sex + avgSpeed + (1|code) + (1|date) + (1|session), data=Position_and_weight)
summary(m1)
...
m2 <- glmmTMB(back ~ rank + age2 + sex + rank*sex + avgSpeed + (1|code) + (1|session) + (1|date), data=Position_and_weight)
summary(m2)
...
m3 <- glmmTMB(center ~ rank + age2 + sex + rank*sex + avgSpeed + (1|code) + (1|session) + (1|date), data=Position_and_weight)
summary(m3)
...
m4 <- glmmTMB(side ~ rank + age2 + sex + rank*sex + avgSpeed + (1|code) + (1|session) + (1|date), data=Position_and_weight)
summary(m4)
...
m5 <- glmmTMB(front.bin ~ rank + age2 + sex + rank*sex + avgSpeed + (1|code) + (1|session) + (1|date), data=Position_and_weight)
summary(m5)
...
m6 <- glmmTMB(meanRank ~ rank + age2 + sex + rank*sex + avgSpeed + (1|code) + (1|session) + (1|date), data=Position_and_weight)
summary(m6)
...
#check to see if activity levels impact position 
...
zfront <- glmmTMB(zWeightID ~ front*rank + front*age2 + front*sex + front:rank:sex + avgSpeed + (1|code) + (1|date) + (1|session), data= Position_and_weight)
summary(zfront)
...
zback <- glmmTMB(zWeightID ~ back*rank + back*age2 + back*sex+ back:rank:sex + avgSpeed + (1|code) + (1|date) + (1|session), data= Position_and_weight)
summary(zback)
...
zcentre <- glmmTMB(zWeightID ~ center*rank + center*age2 + center*sex + center:rank:sex + avgSpeed + (1|code) + (1|date) + (1|session), data= Position_and_weight)
summary(zcentre)
...
zside <- glmmTMB(zWeightID ~ side*rank + side*age2 + side*sex + side:rank:sex + avgSpeed + (1|code) + (1|date) + (1|session), data= Position_and_weight)
summary(zside)
...
zfront.bin <- glmmTMB(zWeightID ~ front.bin*rank + front.bin*age2 + front.bin*sex + front.bin:rank:sex + avgSpeed + (1|code) + (1|date) + (1|session), data= Position_and_weight)
summary(zfront.bin)
...
hist(Position_and_weight$meanRank)
zmeanRank <- glmmTMB(zWeightID ~ meanRank*rank + meanRank*age2 + meanRank*sex + meanRank:rank:sex + avgSpeed + (1|code) + (1|date) + (1|session), data= Position_and_weight)
summary(zmeanRank)
